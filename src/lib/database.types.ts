  ...
  public: {
    Tables: {
      ...
      editorial_picks: {
        ...
        Relationships: [
          {
            foreignKeyName: "editorial_picks_article_id_fkey"
            columns: ["article_id"]
            isOneToOne: false
            referencedRelation: "articles"
            referencedColumns: ["id"]
          ...
          {
            foreignKeyName: "editorial_picks_curated_by_fkey"
            columns: ["curated_by"]
            isOneToOne: false
            referencedRelation: "profiles"
            referencedColumns: ["id"]
    ...
    Functions: {
      compute_hot_score: {
        Args: { karma: number; published: string }
        Returns: number
      }
      increment_views: { Args: { article: string }; Returns: undefined }
